...
CoverTreeNode<val_t> CTHist<val_t>::mergeNode(const CoverTreeNode<val_t> & n1,const CoverTreeNode<val_t> & n2)
{
...
template <typename val_t>
void CTHist<val_t>::insertMerge(CoverTreeNode<val_t> x)
{
...
template <typename val_t>
void CTHist<val_t>::insert(DVec pos,val_t value)
{
	insert(CoverTreeNode<val_t>(pos,value));
}

template <typename val_t>
void CTHist<val_t>::insert(CoverTreeNode<val_t> x)
{
	if (_elem_count == 0)
	{
...
val_t CTHist<val_t>::get_avg(DVec pos) const
{
	...
	//std::cout << "Pos: " << ::to_string(pos) << std::endl;
	//std::cout << "nearest: " << ::to_string(nearest->pos) << std::endl;
	//std::cout << "opp_dir: " << ::to_string(opp_dir->pos) << std::endl;
	...
	//std::cout << "sum1,sum2: " << sum1 << "," << sum2 << std::endl;
	//std::cout << "dist: " << dist(opp_dir->pos,pos) << std::endl;
...
{
	//std::cout << n << " n,t " << t << std::endl << std::flush;
